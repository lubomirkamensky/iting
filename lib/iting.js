...
export function throwCoins() {
  ...
  if (window.hexa1 != "" && window.hexa2 != "") {
  	...
  	document.getElementById('itingbox2').insertAdjacentHTML("beforeend", makePrediction(window.hexa2)+window.start_prediction);
  }

  if (window.hexa1 != "" && window.hexa2 == "") {
  	document.getElementById('itingbox2').innerHTML = ""
  	document.getElementById('itingbox2').insertAdjacentHTML("beforeend", makePrediction(window.hexa1)+window.start_prediction);
  }
